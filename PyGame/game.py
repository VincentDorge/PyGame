...
class Game:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("The PyGame - Le Commencement")
        ...
        #definir une liste de stockage des rectangles de collision
        self.walls = []
        ...
        #definir le rect de collision pour l'entree de la maison
    ...
    def switch_house(self):
        ...
        #recuperer point de spawn  devant la maison
    ...
    def update(self):
      ...
      #  if self.map == 'carte' and self.player.feet.colliderect(self.enter_house_rect):
      #      self.switch_house()
      #      self.map = 'house'
